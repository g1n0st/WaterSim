...
class MGPCGPoissonSolver:
    ...
    @ti.func
    def is_fluid(self, l : ti.template(), I):
        return self.grid_type[l][I] == self.FLUID
    ...
    def smooth(self, l: ti.template(), phase: ti.template()):
        ...
        for I in ti.grouped(self.r[l]):
            if (I.sum()) & 1 == phase and self.is_fluid(l, I):
